...
\begin{solution} 
	...
	% This graph cannot be planar. According to Euler's corollary, if $m > 3n - 6$, then the graph is nonplanar, where m is the number of edges and n is the number of nodes. We know that the sum of degrees is twice the number of edges. Here, $24 = 2m \implies m = 12$. n is 6. Plugging this into the inequality, we get $12 > 18-6=12$.
	\\
