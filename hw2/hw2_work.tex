...
\begin{solution} % solution 3
    ...
    \medskip\noindent
    (a) $5^{1627}\pmod{12} \equiv 5\cdot (5^2)^{813}\pmod{12} \equiv 5\cdot (25)^{813}\pmod{12} \equiv 5\cdot (1)^{813}\pmod{12} \equiv 5\pmod{12}.$
    ...
    \medskip\noindent
    (c) Accodring to Fermat's Little Theorem, $a^{p-1} \equiv 1\pmod{p}$, where p is prime. We can rewrite $8^{-1}\pmod{17}$ as $8a \equiv 1\pmod{17}$
